...
func TestMetricsIncrement(t *testing.T) {
	...
	CacheMisses.Add(2)
	CategoryQueries.Inc()
	HTTPRequests.WithLabelValues("product-service", "GET", "/health", "200").Inc()
	HTTPRequestDuration.WithLabelValues("product-service", "GET", "/health").Observe(0.1)
	...
	if got := testutil.ToFloat64(HTTPRequests.WithLabelValues("product-service", "GET", "/health", "200")); got != 1 {
