...
# Public Subnet (para NAT Gateway e Load Balancer)
...
# Private Subnet (para EKS nodes e RDS)
...
# Segunda Private Subnet (requisito RDS: mínimo 2 AZs diferentes)
...
# VPC Flow Logs (optional, para debugging)
